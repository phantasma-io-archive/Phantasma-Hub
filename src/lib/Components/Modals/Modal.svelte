...
{#if modalType == ModalType.Information}
	<div
		...
		aria-hidden="true"
		class:hidden={!close}
		class="hidden overflow-y-auto overflow-x-hidden bg-slate-400 bg-opacity-50 fixed top-0 right-0 left-0 z-[20000] p-4 w-full md:inset-0 h-modal md:h-full"
	>
		<div
			class="flex align-middle items-center justify-items-center justify-center mx-auto w-full max-w-2xl h-full md:h-auto"
		>
			<!-- Modal content -->
