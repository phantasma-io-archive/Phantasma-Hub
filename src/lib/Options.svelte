<script>
    ...
    import { rightSidebarMenu} from '$lib/store';
...
<div class="fixed-plugin">
    <a href="#" class="bottom-7.5 right-7.5 text-xl z-990 shadow-soft-lg rounded-circle fixed cursor-pointer bg-white px-4 py-2 text-slate-700 fixed-plugin-button" on:click={rightSideNavTrigger}>
